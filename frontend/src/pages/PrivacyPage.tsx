            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-card rounded-[2rem] p-8 md:p-14 shadow-2xl shadow-slate-200/50 border border-border animate-slide-up">
                    <div className="flex items-center gap-4 mb-10 pb-10 border-b border-border">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl font-black text-text-primary tracking-tight">Política de Privacidade</h1>
                    ...
                    <div className="space-y-10 text-text-secondary">
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">1. Coleta e Uso de Dados</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">2. Proteção do Seu Banco de Dados</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">3. Notificações e Canais</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">4. Exclusão e Modificações</h2>
                            <p className="leading-relaxed">

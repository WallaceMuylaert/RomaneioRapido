...
const calculatePasswordStrength = (password: string): { score: number, color: string, label: string } => {
    if (!password) return { score: 0, color: 'bg-border', label: '' }
    ...
    if (score < 2) return { score: 25, color: 'bg-error', label: 'Fraca' }
    if (score < 4) return { score: 60, color: 'bg-warning', label: 'Razoável' }
                    ...
                    {activeTab === 'general' && (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-12 relative group/header">
                                ...
                                >
                                    <div className="w-32 h-32 rounded-[2rem] bg-brand-50 flex items-center justify-center overflow-hidden ring-4 ring-card shadow-xl shadow-primary/10 transition-transform duration-500 group-hover:scale-[1.02]">
                                        {imagePreview ? (
                                    ...
                                    <div className="absolute inset-0 bg-brand-900/40 backdrop-blur-[2px] rounded-[2rem] opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center justify-center text-card">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                                    <div className="sm:col-span-2 group/input">
                                        ...
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                                                <UserIcon className="h-5 w-5 text-text-secondary/60 group-focus-within/input:text-brand-500 transition-colors" />
                                            </div>
                                            <input
                                                required
                                                value={form.full_name}
                                                onChange={(e) => setForm({ ...form, full_name: e.target.value })}
                                                className="w-full h-12 pl-12 pr-4 text-sm font-semibold bg-background/50 border border-border rounded-2xl focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-400 focus:bg-card hover:bg-background transition-all duration-300 shadow-sm"
                                            />
                                        </div>
                                    </div>

                                    <div className="sm:col-span-2 group/input">
                                        <label className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-2 block ml-1">Nome da Loja</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                                                <Store className="h-5 w-5 text-text-secondary/60 group-focus-within/input:text-brand-500 transition-colors" />
                                            </div>
                                            <input
                                    ...
                                    <div className="group/input">
                                        <label className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-2 block ml-1">E-mail</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                                                <Mail className="h-5 w-5 text-text-secondary/60 group-focus-within/input:text-brand-500 transition-colors" />
                                            </div>
                                            <input
                                                required
                                                type="email"
                                    ...
                                    <div className="group/input">
                                        <label className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-2 block ml-1">Telefone</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                                                <Phone className="h-5 w-5 text-text-secondary/60 group-focus-within/input:text-brand-500 transition-colors" />
                                            </div>
                                            <input
                                                value={form.phone}
                                    ...
                                    <div className="sm:col-span-2 group/input">
                                        <label className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-2 block ml-1">Chave Pìx (Para Recebimento)</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                                                <Zap className="h-5 w-5 text-text-secondary/60 group-focus-within/input:text-brand-500 transition-colors" />
                                            </div>
                                            <input
                                                value={form.pix_key}
                                        ...
                                        <p className="text-[10px] text-text-secondary mt-2 ml-1">Esta chave será impressa no PDF do romaneio para facilitar o pagamento via QR Code.</p>
                                    </div>
                                </div>
                                ...
                                <div className="pt-6 flex justify-center">
                                    <button
                                        type="submit"
                                        disabled={saving}
                                        className="h-12 px-8 font-bold bg-brand-600 text-card rounded-2xl hover:bg-brand-700 transition-all shadow-lg shadow-primary/30 flex items-center gap-2 active:scale-95 disabled:opacity-60"
                                    >
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 relative max-w-4xl mx-auto">
                            ...
                            <div className="flex flex-col gap-10 mb-8">
                                ...
                                <div className="w-full">
                                    <div className="bg-card border border-brand-100 rounded-[2.5rem] p-8 sm:p-10 shadow-xl shadow-brand-100/50 relative overflow-hidden group/plan">
                                        ...
                                        <div className="relative z-10 flex flex-col md:flex-row gap-6 md:gap-12 items-center justify-between">
                                            <div className="flex-1 text-center md:text-left space-y-4">
                                                <div className="flex flex-col sm:flex-row items-center gap-3 justify-center md:justify-start">
                                                    <h4 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-text-primary tracking-tight">{currentPlan.name}</h4>
                                                    {user?.subscription_status === 'past_due' ? (
                                                        <span className="px-3 py-1 bg-warning/10 text-warning border border-amber-100/50 text-[10px] font-black uppercase tracking-widest rounded-lg flex items-center gap-1.5 shadow-sm">
                                                ...
                                                <p className="text-text-secondary text-sm font-medium max-w-sm mx-auto md:mx-0 leading-relaxed">{currentPlan.description}</p>
                                                ...
                                                {user?.plan_id && !['trial'].includes(user.plan_id) && (
                                                    <div className="pt-2 flex justify-center md:justify-start">
                                                        <button
                                                            ...
                                                            className={`h-11 px-5 text-sm font-bold rounded-xl transition-all shadow-lg flex items-center gap-2 active:scale-95 group/btn ${user?.subscription_status === 'past_due' ? 'bg-warning text-card hover:bg-warning shadow-amber-500/30' : 'bg-text-primary text-card hover:bg-brand-600 shadow-slate-200'}`}
                                                        >
                                                            <CreditCard className={`w-4 h-4 transition-colors ${user?.subscription_status === 'past_due' ? 'text-amber-100 group-hover/btn:text-card' : 'text-text-secondary group-hover/btn:text-card'}`} />
                                            ...
                                            {/* Progress Meters */}
                                            <div className="w-full md:w-80 lg:w-96 flex-shrink-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-4 lg:gap-6 bg-background/80 p-5 lg:p-8 rounded-[2rem] border border-border/50 shadow-inner">
                                                <div className="group/progress">
                                                    <div className="flex justify-between items-end mb-2 px-0.5">
                                                        <span className="text-[10px] font-black text-text-secondary uppercase tracking-widest">Produtos</span>
                                                        <span className="text-xs lg:text-sm font-black text-text-secondary">
                                                            <span className="text-brand-600 text-lg lg:text-xl">{usage.products.used}</span>
                                                            <span className="text-text-secondary/60 mx-1 font-light">/</span>
                                                            {usage.products.limit >= 999999 ? '∞' : usage.products.limit}
                                                        </span>
                                                    </div>
                                                    <div className="h-2 w-full bg-border/50 rounded-full overflow-hidden p-0.5 shadow-inner">
                                                        <div
                                                        ...
                                                        >
                                                            <div className="absolute inset-0 bg-card/20 w-full animate-shimmer" style={{ backgroundImage: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.3), transparent)' }} />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="group/progress">
                                                    <div className="flex justify-between items-end mb-2 px-0.5">
                                                        <span className="text-[10px] font-black text-text-secondary uppercase tracking-widest">Categorias</span>
                                                        <span className="text-xs lg:text-sm font-black text-text-secondary">
                                    ...
                                    {user?.plan_id && !['trial'].includes(user.plan_id) && (
                                        <div className="mt-6 flex justify-center md:justify-start">
                                            <button
                                                onClick={handleManageSubscription}
                                                className="h-12 px-6 font-bold bg-border/50 text-text-secondary rounded-2xl hover:bg-brand-600 hover:text-card transition-all shadow-sm flex items-center gap-2 active:scale-95"
                                            >
                                ...
                                <div className="w-full mt-4">
                                    <div className="mb-8 flex items-center justify-between">
                                        <div className="pl-2">
                                            <h3 className="text-2xl font-extrabold text-text-primary tracking-tight">Sua Assinatura</h3>
                                            <p className="text-text-secondary font-medium text-sm">Visualize o status atual e seus limites.</p>
                                        </div>
                                        <Link
                                            to="/onboarding"
                                    ...
                                    />
                                    <div className="mt-10 flex flex-col sm:flex-row items-center sm:items-start gap-5 p-6 bg-brand-50 border border-brand-100/50 rounded-[2rem] text-sm font-medium text-brand-800 shadow-sm max-w-3xl mx-auto text-center sm:text-left transition-all hover:bg-card hover:shadow-md">
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 relative max-w-3xl mx-auto">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6 max-w-xl mx-auto">
                                ...
                                <div className="space-y-5">
                                    <div className="group/input">
                                        <label className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-2 block ml-1">Nova Senha</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                                                <Key className="h-5 w-5 text-text-secondary/60 group-focus-within/input:text-brand-500 transition-colors" />
                                            </div>
                                            <input
                                                ...
                                                className="w-full h-12 pl-12 pr-12 text-sm font-semibold bg-background/50 border border-border rounded-2xl focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-400 focus:bg-card hover:bg-background transition-all duration-300 shadow-sm"
                                                placeholder="••••••••"
                                            />
                                            <button
                                                type="button"
                                                onClick={() => setShowPassword(!showPassword)}
                                                className="absolute inset-y-0 right-4 flex items-center text-text-secondary hover:text-text-secondary focus:outline-none transition-colors"
                                            >
                                        ...
                                        {form.password && (
                                            <div className="mt-3 px-1 animate-in fade-in zoom-in-95 duration-300">
                                                <div className="flex justify-between items-center mb-1.5">
                                                    <span className="text-[10px] font-black uppercase tracking-widest text-text-secondary">Força da Senha</span>
                                                ...
                                                <div className="h-1.5 w-full bg-border/50 rounded-full overflow-hidden flex gap-0.5">
                                                    <div
                                    ...
                                    <div className="group/input">
                                        <label className="text-[11px] font-bold text-text-secondary uppercase tracking-wider mb-2 block ml-1">Confirme a Nova Senha</label>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                                                <Key className="h-5 w-5 text-text-secondary/60 group-focus-within/input:text-brand-500 transition-colors" />
                                            </div>
                                ...
                                <div className="pt-8 flex justify-center">
                                    <button
                                        ...
                                        className="h-12 px-8 font-bold bg-text-primary/90 text-card rounded-2xl hover:bg-text-primary transition-all shadow-lg shadow-slate-300 flex items-center gap-2 active:scale-95 disabled:opacity-60"
                                    >
                            ...
                            <div className="mt-16 pt-12 border-t-2 border-border/80">
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-2 text-center sm:text-left">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-extrabold text-text-primary tracking-tight">Chaves de API</h3>
                                        <p className="text-sm font-medium text-text-secondary mt-0.5">Integre com sistemas externos usando suas chaves pessoais.</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="mt-8 p-8 bg-gradient-to-br from-brand-50 via-white to-brand-50/30 rounded-[2rem] border border-brand-100/60 shadow-lg shadow-brand-100/20 relative overflow-hidden">
                                        ...
                                        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6">
                                            ...
                                            <div className="flex-1 text-center sm:text-left">
                                                <h4 className="text-lg font-extrabold text-text-primary mb-1">Recurso exclusivo do plano API Especialista</h4>
                                            ...
                                            <button
                                                ...
                                                className="h-12 px-6 font-bold bg-brand-600 text-card rounded-2xl hover:bg-brand-700 transition-all shadow-lg shadow-primary/30 flex items-center gap-2 active:scale-95 shrink-0"
                                            >
                                    ...
                                    <div className="mt-8 space-y-8">
                                        ...
                                        {newlyCreatedKey && (
                                            <div className="p-6 bg-emerald-50 rounded-3xl border-2 border-emerald-200 shadow-lg shadow-emerald-100/50 animate-in fade-in zoom-in-95 duration-300">
                                                ...
                                                <div className="p-4 bg-card rounded-2xl border border-emerald-100 shadow-inner mb-4">
                                                    <code className="text-sm font-mono font-bold text-text-secondary break-all select-all">{newlyCreatedKey}</code>
                                                </div>
                                                <div className="flex flex-col sm:flex-row items-center gap-3">
                                                    <button
                                                        onClick={() => handleCopyKey(newlyCreatedKey)}
                                                        className={`h-10 px-5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all ${keyCopied
                                                            ? 'bg-emerald-600 text-card'
                                                    ...
                                                    <button
                                                        ...
                                                        className="h-10 px-5 rounded-xl text-sm font-bold bg-border/50 text-text-secondary hover:bg-border transition-all"
                                                    >
                                                        Fechar
                                                    </button>
                                                </div>
                                                <p className="text-xs font-bold text-warning bg-warning/10 px-3 py-2 rounded-xl mt-4 flex items-center gap-2">
                                        ...
                                        <div className="p-6 bg-card rounded-3xl border border-border/80 shadow-sm">
                                            <div className="flex items-center justify-between mb-4">
                                                <span className="text-xs font-black text-text-secondary uppercase tracking-widest">Nova Chave</span>
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-3">
                                                <input
                                                    ...
                                                    maxLength={100}
                                                    className="flex-1 h-12 px-5 text-sm font-semibold bg-background/50 border border-border rounded-2xl focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-400 focus:bg-card transition-all shadow-sm"
                                                />
                                                <button
                                                    onClick={handleCreateApiKey}
                                                    disabled={isCreatingApiKey || !apiKeyName.trim()}
                                                    className="h-12 px-6 font-bold bg-brand-600 text-card rounded-2xl hover:bg-brand-700 transition-all shadow-lg shadow-primary/30 flex items-center gap-2 active:scale-95 disabled:opacity-60 shrink-0"
                                                >
                                        ...
                                        {isLoadingApiKeys ? (
                                            ...
                                            <div className="text-center py-12">
                                                <KeyRound className="w-12 h-12 text-text-secondary/40 mx-auto mb-4" />
                                                <p className="text-sm font-bold text-text-secondary">Nenhuma chave de API criada.</p>
                                                <p className="text-xs font-medium text-text-secondary/60 mt-1">Crie sua primeira chave para começar a integrar.</p>
                                            </div>
                                        ) : (
                                                ...
                                                {apiKeys.map(k => (
                                                    <div
                                                        ...
                                                        className={`group p-5 rounded-2xl border transition-all duration-300 ${k.is_active
                                                            ? 'bg-card border-border/80 hover:border-brand-200 hover:shadow-md'
                                                            : 'bg-background/50 border-border opacity-60'
                                                            }`}
                                                    >
                                                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                                            <div className="flex items-center gap-4 min-w-0">
                                                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${k.is_active ? 'bg-brand-50 text-brand-600' : 'bg-border/50 text-text-secondary'
                                                                    }`}>
                                                                    <Key className="w-5 h-5" />
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="flex items-center gap-2">
                                                                        <span className="text-sm font-bold text-text-primary truncate">{k.name}</span>
                                                                    ...
                                                                    <div className="flex items-center gap-3 mt-1">
                                                                        <code className="text-xs font-mono font-bold text-text-secondary">{k.key_prefix}•••••••</code>
                                                                        {k.created_at && (
                                                                ...
                                                                <div className="shrink-0">
                                                                    {confirmRevokeId === k.id ? (
                                                                        <div className="flex items-center gap-2 animate-in fade-in zoom-in-95 duration-200">
                                                                            <span className="text-xs font-bold text-error">Confirmar?</span>
                                                                            <button
                                                                                onClick={() => handleRevokeApiKey(k.id)}
                                                                                disabled={revokingKeyId === k.id}
                                                                                className="h-8 px-3 rounded-lg text-xs font-bold bg-error text-card hover:bg-error transition-all flex items-center gap-1 disabled:opacity-60"
                                                                            >
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                className="h-8 px-3 rounded-lg text-xs font-bold bg-border/50 text-text-secondary hover:bg-border transition-all"
                                                                            >
                                                                                Não
                                                                            </button>
                                                                        </div>
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className="h-9 px-4 rounded-xl text-xs font-bold text-error bg-error/10 hover:bg-error/20 transition-all flex items-center gap-1.5 opacity-0 group-hover:opacity-100"
                                                                        >
                                        ...
                                        <div className="flex items-center gap-3 p-4 bg-background rounded-2xl border border-border">
                                            ...
                                            <p className="text-xs font-medium text-text-secondary leading-relaxed">
                                                Cada chave é autenticada via header <code className="px-1.5 py-0.5 bg-card rounded-md border border-border text-[11px] font-mono font-bold text-text-secondary">X-API-Key</code>.

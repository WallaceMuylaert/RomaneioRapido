            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-[2rem] p-8 md:p-14 shadow-2xl shadow-slate-200/50 border border-slate-100 animate-slide-up">
                    <div className="flex items-center gap-4 mb-10 pb-10 border-b border-slate-100">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">Política de Cookies</h1>
                    ...
                    <div className="space-y-10 text-slate-600">
                        <section>
                            <h2 className="text-xl font-bold text-slate-900 mb-4 tracking-tight">O que são Cookies?</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-slate-900 mb-4 tracking-tight">Gerenciamento no seu Navegador</h2>
                            <p className="leading-relaxed">

            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-card rounded-[2rem] p-8 md:p-14 shadow-2xl shadow-slate-200/50 border border-border animate-slide-up">
                    <div className="flex items-center gap-4 mb-10 pb-10 border-b border-border">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl font-black text-text-primary tracking-tight">Termos de Uso</h1>
                    ...
                    <div className="space-y-10 text-text-secondary">
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">1. Aceitação dos Termos</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">2. Descrição do Serviço</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">3. Conta do Usuário</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">4. Uso Aceitável</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-text-primary mb-4 tracking-tight">5. Alterações nos Termos</h2>
                            <p className="leading-relaxed">
                        ...
                        <section className="bg-background p-6 rounded-2xl border border-border">
                            <h2 className="text-lg font-bold text-text-primary mb-2">6. Contato</h2>

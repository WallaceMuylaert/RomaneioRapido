...
export default function PaymentFailedBanner() {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-[100] animate-in slide-in-from-top duration-500">
            <div className="bg-gradient-to-r from-amber-500 via-amber-500 to-orange-500 text-white px-4 py-3 shadow-lg shadow-amber-500/25">
                <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        <button
                            ...
                            className="h-8 px-4 bg-white text-amber-700 rounded-lg text-xs font-bold hover:bg-amber-50 transition-all shadow-sm flex items-center gap-1.5 active:scale-95"
                        >
